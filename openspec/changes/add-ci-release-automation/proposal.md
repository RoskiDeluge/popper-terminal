...
- Add GitHub Actions release automation that builds distributable artifacts and publishes a GitHub release from a version tag.
- Add GitHub-generated release notes and a release preparation helper for cutting the next patch version safely.
...
- Affected code: `.github/workflows/*`, `package.json`, `package-lock.json`, `src-tauri/Cargo.toml`, `src-tauri/tauri.conf.json`, `docs/releasing.md`, `scripts/prepare-release.mjs`
